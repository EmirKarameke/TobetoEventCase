...
namespace EventCase.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20240714145107_eventRequestUpdate")]
    partial class eventRequestUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventCase.Domain.EventRequests.EventRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EventCase.Domain.Employees.Member", b =>
                {
                    b.HasOne("EventCase.Domain.EventRequests.EventRequest", null)
                        .WithMany("Member")
            ...
            modelBuilder.Entity("EventCase.Domain.EventRequests.EventRequest", b =>
                {
                    b.HasOne("EventCase.Domain.Events.Event", "Event")
                        .WithMany()
            ...
            modelBuilder.Entity("EventCase.Domain.Events.Event", b =>
                {
                    b.HasOne("EventCase.Domain.Employees.Member", "Member")
                        .WithMany("Events")
